...
#ND: Fix path to point to user version of foldx

foldx_path = '/Applications/foldx5MacC11.tar_/'


def construct_position_scan_string (pdb_name='', location_file='', chain = None, filter= None):
...
def run_repair_model(pdb_name, pdb_dir, out_dir):
    ...
    """
    command = foldx_path + "foldx --command=RepairPDB --pdb-dir=" + pdb_dir + " --pdb=" + pdb_name + '.pdb'
